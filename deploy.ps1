param([string]$GitToken = "", [string]$OrgName = "altinnbeta", [string]$RepoName = "altinndigital.no", [string]$UserEmail = "", [string]$UserName = "", [int]$RunTidy = 0)

cd ..
git clone https://dev.azure.com/brreg/altinndigital.no/_git/$RepoName-site 
cd $PSScriptRoot
